...
/* ============================================================
   ...
   */
   ...
   /*
     ...
     You should fill this with the actual school calendar.
   */
   ...
   /*
     Determines what day should be shown in the header.
   
     Before 2:30 PM:
     shows today's schedule.
   
     After 2:30 PM:
     shows the next school day.
   */
   ...
   function renderDayMessage() {
     ...
     if (info.relation === "today") {
       ...
       dayMessage.innerHTML =
         `Today is a <span>${info.type}</span> Day.`;
       ...
       dayMessage.innerHTML =
         `${weekday} will be a <span>${info.type}</span> Day.`;
  ...
  return;
   ...
   function renderSchedule() {
     ...
     /*
       Combine classes and lunches for display.
     */
